...
const DisplayGamesPagination = ({
  ...
  return (
    <div className="admin-details-pagination display-games-pagination">
...
DisplayGamesPagination.propTypes = {
...
export default DisplayGamesPagination;
